...
$arCurrentShops = array (
	...
	echo 'Were you looking for <a href="http://simplest-shop.com/books/search/'. ($_GET['Search']) .'">'. ($_GET['Search']) .'</a> in our <a href="http://simplest-shop.com/books">books shop</a> ?<br />';
